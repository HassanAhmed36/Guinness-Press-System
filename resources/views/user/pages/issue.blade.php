    ...
    @php
        if ($journal->path == $abbs) {
            ...
            foreach ($journal->settings as $detail) {
                ...
                if ($detail->setting_name == 'about' && $detail->locale == 'en') {
                    $about_journal = $detail->setting_value;
                }
...
$keywords = '';
$description = '';
if ($array['journal_abbr'] == 'ijerm' && $array['issue_no'] == 1001) {
    $title = 'International Journal of Empirical Research Methods | Volume 1 Issue 1';
    $keywords = 'International empirical research, Quantitative research techniques, Qualitative research methodologies';
    $description = 'Dive into the inaugural issue of Guinness Press`s International Journal of Empirical Research Methods. Explore groundbreaking studies and methodologies shaping global research landscapes';
}
if ($array['journal_abbr'] == 'ijerm' && $array['issue_no'] == 1002) {
    $title = 'International Journal of Empirical Research Methods | Volume 1 Issue 2';
    $keywords = 'Experimental design principles, Survey research techniques, Research methodology articles';
    $description = 'Discover Guinness Press`s International Journal of Empirical Research Methods Vol. 1, Issue 2. Explore innovative studies shaping scholarly discourse globally.';
}
if ($array['journal_abbr'] == 'ijerm' && $array['issue_no'] == 2001) {
    $title = 'International Journal of Empirical Research Methods | Volume 2 Issue 1';
    $keywords = 'empirical research method, empirical research, Empirical research methods journal';
    $description = 'Explore Guinness Press`s International Journal of Empirical Research Methods Vol. 2, Issue 1. Discover insightful studies, methodologies, and findings shaping diverse disciplines globally.';
}
if ($array['journal_abbr'] == 'cli' && $array['issue_no'] == 1001) {
    $title = 'Cultural Landscape Insights Journal | Volume 1 Issue 1';
    $keywords = 'Cultural geography insights, Interdisciplinary landscape research, Cultural heritage publications';
    $description = 'Discover rich insights into cultural geography and heritage landscapes in Volume 2, Issue 1 of Cultural Landscape Insights by Guinness Press. Explore now!';
}
if ($array['journal_abbr'] == 'cli' && $array['issue_no'] == 1002) {
    $title = 'Cultural Landscape Insights Journal | Volume 1 Issue 2';
    $keywords = 'Landscape interpretation journal, Cross-disciplinary cultural studies, Cultural environment insights';
    $description = 'Unlock interdisciplinary perspectives on cultural landscapes in Volume 2, Issue 1 of Cultural Landscape Insights by Guinness Press. Explore our latest insights now!';
}
if ($array['journal_abbr'] == 'cli' && $array['issue_no'] == 2001) {
    $title = 'Cultural Landscape Insights Journal | Volume 2 Issue 1';
    $keywords = 'Cultural landscape studies, Multidisciplinary cultural insights, Landscape analysis journal';
    $description = 'Dive into multidisciplinary cultural landscape studies with Volume 2, Issue 1 of Cultural Landscape Insights by Guinness Press. Explore diverse perspectives now.';
}
if ($array['journal_abbr'] == 'seer' && $array['issue_no'] == 1001) {
    $title = 'Sustainable Energy and Environment Review | Volume 1 Issue 1';
    $keywords = 'Sustainable energy review, Environment review journal, Renewable energy analysis';
    $description = 'Explore inaugural issue of Sustainable Energy and Environment Review by Guinness Press. Renewable energy, eco-tech, climate change insights.';
}
if ($array['journal_abbr'] == 'cie' && $array['issue_no'] == 1001) {
    $title = 'Current Integrative Engineering Journal | Volume 1 Issue 1';
    $keywords = 'Engineering integration studies, Interdisciplinary engineering articles, Multidisciplinary engineering journal';
    $description = 'Explore Volume 1, Issue 1 of Current Integrative Engineering by Guinness Press. Discover integrative engineering trends and innovative studies in this groundbreaking journal.';
}
if ($array['journal_abbr'] == 'cie' && $array['issue_no'] == 2001) {
    $title = 'Current Integrative Engineering Journal | Volume 2 Issue 1';
    $keywords = 'Integrative engineering journal, Current engineering research, Engineering innovation articles';
    $description = 'Dive into Volume 2, Issue 1 of Current Integrative Engineering by Guinness Press. Discover innovative articles on integrative engineering trends and multidisciplinary studies.';
}
if ($array['journal_abbr'] == 'jblm' && $array['issue_no'] == 2001) {
    $title = 'Journal of Business Leadership and Management | Volume 2 Issue 1';
    $keywords = 'Management research papers, Leadership journal articles, Management journal submissions';
    $description = 'Discover latest insights on business leadership & management. Volume 2, Issue 1 now available. Explore leadership strategies & management trends.';
}
if ($array['journal_abbr'] == 'rer' && $array['issue_no'] == 1001) {
    $title = 'Recent Educational Research Journal | Volume 1 Issue 1';
    $keywords = 'Scholarly education articles, Academic research in education, Contemporary educational research';
    $description = 'Discover groundbreaking insights in educational research with Volume 1, Issue 1 of Recent Educational Research by Guinness Press. Explore scholarly articles today!';
}
if ($array['journal_abbr'] == 'rer' && $array['issue_no'] == 1002) {
    $title = 'Recent Educational Research Journal | Volume 1 Issue 2';
    $keywords = 'Education studies journal, Cutting-edge educational research, Innovative education research';
    $description = 'Dive into the latest educational research findings in Volume 1, Issue 2 of Recent Educational Research by Guinness Press. Explore scholarly insights now!';
}
if ($array['journal_abbr'] == 'rer' && $array['issue_no'] == 2001) {
    $title = 'Recent Educational Research Journal | Volume 2 Issue 1';
    $keywords = 'Recent educational research, Educational research journals, Latest educational studies';
    $description = 'Explore the latest findings in educational research with Volume 2, Issue 1 of Recent Educational Research by Guinness Press. Scholarly articles on cutting-edge topics await!';
}
if ($array['journal_abbr'] == 'pb' && $array['issue_no'] == 1001) {
    $title = 'Pharmaceutical Breakthroughs Journal | Volume 1 Issue 1';
    $keywords = 'Pharmaceutical advancements, Healthcare innovations, Pharmacological discoveries';
    $description = 'Discover the latest pharmaceutical advancements in Volume 1, Issue 1 of Pharmaceutical Breakthroughs by Guinness Press.';
}
?>
@section('title', $title)
            ...
            <div class="container">
                <div class="row search-titles issues_row_titles">
                    ...
                    <div class="col-md-11 col-xl-11 col-sm-12 m-xl-auto m-md-auto">
                        <h3 class="explore-h">Volume @if ($array['issue_no'] == 2001 || $array['issue_no'] == 2002)
                                2
                            @else
                                1
                            @endif @isset($year)
                            {!! $year !!}
                            @endisset, Issue @if ($array['issue_no'] == 1001)
                                1
                            @elseif($array['issue_no'] == 1002)
                                2
                            @elseif($array['issue_no'] == 2001)
                                1
                            @elseif($array['issue_no'] == 2002)
                                2
                            @endif
                        </h3>
                ...
                <div class="row search-journal-row">
                    ...
                    <div class="col-md-11 col-xl-11 col-sm-12 m-xl-auto m-md-auto">
                            ...
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024923">A
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024923"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024924">INTOLERANCE
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024924"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024925">ADAPTATION
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024925"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024926">A
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024926"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024927">EXAMINING
                                                THE IMPACT OF USING AUTHENTIC MATERIALS ON ESL/EFL LEARNERS</a></h2>
                                        <p>Author(s): Mark Treve</p>
                                        <div class="article-btn">
                                            <p>Article | Published Online: 05 Oct 2023 | Pages [40 - 50]</p>
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024927"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024928">THE
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024928"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024929">DEPLOYMENT
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1024929"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'ijerm' && $array['issue_no'] == 1002)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122141">Deployment
                                                of Lean Six Sigma in Transportation Sector</a></h2>
                                        <p>Author(s): Noor Azam Bin MD Saad</p>
                                        <div class="article-btn">
                                            <p>Article | Published Online: 05 Dec 2023 | Pages [74 - 80]</p>
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122141"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122142">Conceptualization
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122142"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122143">A
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122143"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122144">Integrative
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122144"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122145">Covid-
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122145"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <!--<div class="article-titles">-->
                                    <!--          <h2><a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122146">Isdaanon Ballad: A Descriptive Analysis of the Verbal Arts of the River Fisherfolks in Capiz, Philippines</a></h2>-->
                                    <!--          <p>Author(s): Leo Andrew B. Biclar</p>-->
                                    <!--          <div class="article-btn">-->
                                    <!--              <p>Article | Published Online: 05 Dec 2023 | Pages [138 - 149]</p>-->
                                    <!--              <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122146" class="btn1">Read More</a>-->
                                    <!--          </div>-->
                                    <!--       </div>-->
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'ijerm' && $array['issue_no'] == 2001)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246021">Unveiling
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246021"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246022">Motivation
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246022"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246023">Client’s
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246023"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246024">Some
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246024"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246025">Dissemination
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246025"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246026">Balancing
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246026"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246027">Psychosocial
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246027"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'jblm' && $array['issue_no'] == 1001)
                            ...
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243012">Examining
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243012"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243013">MALAYSIA
                                                CONSTRUCTION WORKER PERCEPTION ON HEAT STRESS AND ITS IMPACT ON WORK
                                                PERFORMANCE</a></h2>
                                        <p>Author(s): Che Mohammad Nizam, Ahmad Rasdan Ismail, Norlini Husshin</p>
                                        <div class="article-btn">
                                            <p>Article | Published Online: 09 Oct 2023 | Pages [9 - 16]</p>
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243013"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243014">THE
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243014"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243015">OPTIMIZING
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243015"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243016">CLIMATE
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243016"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243017">UTILIZING
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243017"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243018">ECONOMIC
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243018"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <!-- </div>-->
                            <!--</div>  -->
                        @elseif($array['journal_abbr'] == 'jblm' && $array['issue_no'] == 1002)
                            <!--<ul class="nav nav-pills search-journal-nav-pills explore-pills">-->
                            <!--   <li class="nav-item"> <a class="nav-link active" data-toggle="pill" href="#latest" role="tab" aria-controls="pills-latest" aria-selected="true">Vol 01, Issue 01</a> </li>-->
                            <!--<li class="nav-item"> <a class="nav-link" data-toggle="pill" href="#open-access" role="tab" aria-controls="pills-open-access" aria-selected="false">Open access</a> </li>-->
                            <!--<li class="nav-item"> <a class="nav-link" data-toggle="pill" href="#most-read" role="tab" aria-controls="pills-most-read" aria-selected="false">Most Read</a> </li>-->
                            ...
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245001">Teachers’
                                                Research Engagement And Challenges: Bases For Mentoring Program</a></h2>
                                        <p>Author(s): Ronilo G. Berondo</p>
                                        <div class="article-btn">
                                            <p>Article | Published Online: 25 Dec 2023 | Pages [74 - 79]</p>
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245001"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245002">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245002"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245003">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245003"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245004">Development
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245004"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245005">Frequency
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245005"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <!-- </div>-->
                            <!--</div>  -->
                        @elseif($array['journal_abbr'] == 'cli' && $array['issue_no'] == 1001)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242901">Vulnerable
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242901"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242902">Discovering
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242902"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242903">Study
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242903"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242904">Implementation
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242904"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242905">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242905"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <!--<div class="article-titles">-->
                                    <!--   <h2><a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242906">The Impact of Influencer Components on Generation Z's Green Purchase Intentions: The Mediating Role of Green Attitude and Subjective Norms</a></h2>-->
                                    <!--   <p>Author(s): Trinh Le Tan, Tran Minh Tung, Nguyen Duc Quang</p>-->
                                    <!--   <div class="article-btn">-->
                                    <!--       <p>Article | Published Online: 17 Oct 2023 | Pages [51 - 65]</p>-->
                                    <!--       <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242906" class="btn1">Read More</a>-->
                                    <!--   </div>-->
                                    <!--</div>-->
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'cli' && $array['issue_no'] == 1002)
                            <ul class="search-results explore-list">
                                <li>
                                    <!--<div class="article-titles">-->
                                    <!--    <h2><a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245011">Enabling the Cultural and Heritage Management Practices of the Indigenous Peoples</a></h2>-->
                                    <!--    <p>Author(s): Leo Andrew B. Biclar</p>-->
                                    <!--    <div class="article-btn">-->
                                    <!--        <p>Article | Published Online: 05 Dec 2023 | Pages [51 - 61]</p>-->
                                    <!--        <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245011" class="btn1">Read More</a>-->
                                    <!--    </div>-->
                                    <!-- </div>-->
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245011">Encouraging
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245011"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245012">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245012"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245013">Language
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245013"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245014">Development
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245014"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245015">Cultural
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245015"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <!--<div class="article-titles">-->
                        ...
                        @elseif($array['journal_abbr'] == 'cli' && $array['issue_no'] == 2001)
                            <ul class="search-results explore-list">
                                <li>
                                    <!--<div class="article-titles">-->
                                    <!--    <h2><a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5245011">Enabling the Cultural and Heritage Management Practices of the Indigenous Peoples</a></h2>-->
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250901">Organizational
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250901"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250902">Public
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250902"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250903">Relationship
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250903"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250904">Application
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250904"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250905">Interpret
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250905"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250906">DISCOVERING
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5250906"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <!--<div class="article-titles">-->
                        ...
                        @elseif($array['journal_abbr'] == 'cie' && $array['issue_no'] == 1001)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230401">THE
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230401"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230402">ARTIFICIAL
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230402"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230403">CALORIES
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230403"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230404">IMPLEMENTATION
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230404"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230405">A
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5230405"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'seer' && $array['issue_no'] == 1001)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243101">Retraction
                                                Notice</a></h2>
                                        <p>Author(s):</p>
                                        <div class="article-btn">
                                            <p>Article | Published Online: 03 Nov 2023 | Pages [1 - 15]</p>
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243101"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243102">Climate
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243102"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243103">Forest
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243103"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243104">Sustainable
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243104"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243105">Chemical
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243105"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243106">Linking
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243106"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243107">THE
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243107"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'seer' && $array['issue_no'] == 2001)
                            <ul class="search-results explore-list">
                                <li>

                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242201">Floral
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242201"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242202">Microplastic
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242202"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242203">Heavy
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242203"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242204">Access
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242204"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242205">Narrative
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5242205"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                        ...
                        @elseif($array['journal_abbr'] == 'pb' && $array['issue_no'] == 1001)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243201">Comparison
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243201"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243202">Umbilical
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243202"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243203">Breakthrough
                                                Stem Cells Therapy For Children With Autism</a></h2>
                                        <p>Author(s): Deby Susanti Vinski, Natasha Cinta Vinski</p>
                                        <div class="article-btn">
                                            <p>Article | Published Online: 10 Nov 2023 | Pages [17 - 23]</p>
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243203"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243204">Investigation
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243204"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243205">Synthesis
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5243205"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'rer' && $array['issue_no'] == 1001)
                            <ul class="search-results explore-list">
                                <li>

                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244301">Economic
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244301"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244302">Knowledge
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244302"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244303">COVID-19
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244303"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244304">Analyzing
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244304"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244305">Level
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244305"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244306">Speech
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5244306"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                        ...
                        @elseif($array['journal_abbr'] == 'sfr' && $array['issue_no'] == 1001)
                            <ul class="search-results explore-list">
                                <li>

                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122701">An
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122701"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122702">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122702"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122703">Financial
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122703"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122704">Impact
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122704"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122705">Learning
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122705"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122706">Moral
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/1122706"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                        ...
                        @elseif($array['journal_abbr'] == 'rer' && $array['issue_no'] == 1002)
                            <ul class="search-results explore-list">
                                <li>

                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248601">Oral
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248601"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248602">A
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248602"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248603">Differential
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248603"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248604">Linguistic
                                                Errors In Written Discourse</a></h2>
                                        <p>Author(s): Maria Morena E. Dela Peña</p>
                                        <div class="article-btn">
                                            <p>Article | Published Online: 20 Dec 2023 | Pages [119 - 140]</p>
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248604"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248605">Comparing
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248605"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248606">Enhancing
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248606"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                        ...
                        @elseif($array['journal_abbr'] == 'cie' && $array['issue_no'] == 2001)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248801">Fiberglass
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248801"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248802">Analysis
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248802"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248803">Analytical
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248803"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248804">Effect
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248804"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248805">Characterization
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248805"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'jblm' && $array['issue_no'] == 2001)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246301">How
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246301"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246302">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246302"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246303">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246303"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246304">Evaluating
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246304"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246305">Unveiling
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246305"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246306">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5246306"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        @elseif($array['journal_abbr'] == 'rer' && $array['issue_no'] == 2001)
                            <ul class="search-results explore-list">
                                <li>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248901">Conceptual
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248901"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248902">Augustinian
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248902"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248903">Math
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248903"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248904">Project-Based
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248904"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248905">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248905"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                    <div class="article-titles">
                                        <h2><a
                                                href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248906">The
                                        ...
                                        <div class="article-btn">
                                            ...
                                            <a href="{{ url('') }}/publication/journal/{{ $array['journal_abbr'] }}/5248906"
                                                class="btn1">Read More</a>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <!--<div class="col-md-4 col-xl-4 col-sm-12 other-issue">-->
                        <!--    <ul class="nav ">-->
                        <!--       <li class="nav-item"> <a class="nav-link" id="other-issue">Other Issues</a> </li>-->
                        <!--    </ul>   -->
                        <!-- Get Journals -->
                        ...
                        <!--        </div>-->
                        <!--                                 <div class="article-titles">-->
                        <!--           <h2><a href="https://guinnesspress.org/publication/doi/full/10.59762/a-theoretical-perspective-on-how-digitalization-has-evolved-organizational-culture">A THEORETICAL PERSPECTIVE ON HOW DIGITALIZATION HAS EVOLVED ORGANIZATIONAL CULTURE</a></h2>-->
                        <!--           <p>Article | Published Online: 19 May 2023 | Views: 402 | Citations: 2</p> -->
                        <!--        </div>-->
                        <!--                              </li>-->
                        <!--  </ul>-->
