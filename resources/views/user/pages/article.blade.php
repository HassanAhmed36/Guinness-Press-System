...
@extends('layouts.article-template')
@php
    $journalname='';
    $short_description='';
    $abbs = session('abbs');
...
@php
   ...
   $article_vol_value =  ( $article_array["article_code"] == '5242201' || $article_array["article_code"] == '5242202' || $article_array["article_code"] == '5242203' || $article_array["article_code"] == '5242204' || $article_array["article_code"] == '5242205') ? '1' : $article_array["vol_no"]
@endphp
@endforeach
@section('meta_tags')
    @if($article_array["article_code"] == '5246021'){
        <meta name="citation_article_type" content="research">
        <meta name="citation_firstpage" content="1">
        <meta name="citation_journal_abbrev" content="ijerm">
        <meta name="citation_firstpage" content="1">
        <meta name="citation_lastpage" content="15">
        <meta name="citation_volume" content="2">
        <meta name="citation_issue" content="1">
      <meta name="citation_abstract" content="Purpose: This Study Aims To Examine And Demonstrate The Impact Of Perceived Security, Perceived Privacy, System Quality, And Utilitarian Motives On Users’ Actual Use Of Google Drive In Indonesia.
        ...
        Findings: The Structural Model Results Indicate That Perceived Security And Privacy Influence Attitudes And Actual Use. The Relationship Between Attitudes Toward Use Significantly Affects The Actual Use Of Google Drive Among Users In Indonesia. Likewise, Perceived Security And Privacy Significantly Influence Usage Attitudes And Relationships With Actual Use.
        Practical Implications: The Current Research Is Valuable For Google Drive Users To Illustrate The Development Of A Relatively Secure Cloud-Based Google Drive.
        Originality/Value: To The Best Of Our Knowledge, The Current Study Is The First Academic Paper To Broaden Google Drive User Adoption By Examining The Determinants Of Usage Among Google Drive Users.">
...
@section('title', $article_array["article_title"])
@section('articledoi', '10.59762/' . $article_array["journal_abbr"] . $article_array["issn"] .
                                  $article_vol_value
                                   . $article_array["issue_no"] . $article_array["timestamp"] )
@section('description', $article_array["meta_description"] ?? '')
@section('keywords', $article_array["meta_keywords"] ?? '')
@section('citation_author')
   @foreach ($article_array["authors_detail"] as $author_detail)
    <meta name="citation_author" content="{{ $author_detail['name'] }}">
   @endforeach
@endsection
@section('citation_publication_date', $article_array["citation_publication_date"] ?? '')
@section('citation_year', isset($article_array["citation_publication_date"]) ? substr($article_array["citation_publication_date"], 0, 4) : '')
@section('journal_title', $journalname)
@section('journal_image', 'https://newversion.guinnesspress.org/ojs/public/journals/'.$journal_id.'/'. $jsonArray['uploadName'])
@section('issn', $article_array["journal_issn"])
@section('banner')
...
<section class="journal_detail_section">
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <img src="https://newversion.guinnesspress.org/ojs/public/journals/{{$journal_id}}/{{ $jsonArray['uploadName'] }}" class="img-fluid" alt="">
            </div>
            <div class="col-md-10">
                    ...
                    <div class="access_type">
                        <div class="left_access">
                            <h5 class="text-uppercase">
                                ISSN NO : {{$article_array["journal_issn"]}}
                            </h5>
                        </div>
                        <div class="right_access">
                            <img src="https://www.guinnesspress.org/bkp/assets/img/open-access-logo.png" class="img-fluid"/>
                        </div>
                    </div>
                ...
                <div class="btn-group">
                    <a href="javascript:;" data-fancybox="" data-src="#submitArticlePopup" class="btn btn-light btn-blue red-btn ">Submit Your Article</a>
                    <a href="{{url('/journal', ['journal_name' => $journal_path,'journal_p' => 'editorial-board'])}}" class="btn btn-light btn-blue">Editorial Board</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="journal-details">
                   <div class="row">
                      <div class="col-md-2 col-xl-2 col-sm-12">
                            ...
                            <li class="article-corres-author">
                                @php
                                $response = Http::get('https://api.crossref.org/works/10.59762/'. $article_array["journal_abbr"] . $article_array["issn"] . $article_vol_value . $article_array["issue_no"] . $article_array["timestamp"] );

                                $jsonData = $response->json();

                               $crossref_citations = ($jsonData)  ? $jsonData['message']['is-referenced-by-count'] : '0';
                         ...
                         @if( ! (($article_array["journal_abbr"]  == 'cli' && $article_array["article_code"] == '5242906') ||  ($article_array["journal_abbr"]  == 'seer' && $article_array["article_code"] == '5243101')) )
                              <!-- Start of Dimensions  -->
                         <span class="__dimensions_badge_embed__" data-doi="10.59762/{{ $article_array["journal_abbr"] }}{{ $article_array["issn"] }}{{ $article_vol_value }}{{ $article_array["issue_no"] }}{{ $article_array["timestamp"] }}" data-style="small_circle" data-legend="hover-bottom" data-hide-zero-citations="false"></span><script async src="https://badge.dimensions.ai/badge.js" charset="utf-8"></script>
                          <!-- End of Dimensions -->
                         ...
                         <!-- Start Crossmark Snippet v2.0 -->
                             <script src="https://crossmark-cdn.crossref.org/widget/v2.0/widget.js"></script>
                              ...
                              <img src="https://crossmark-cdn.crossref.org/widget/v2.0/logos/CROSSMARK_Color_square.svg" width="70" loading="lazy"/>
                                </a>
                      ...
                      <div class="col-md-6 col-xl-6 col-sm-12">
                         <div class="article-sec1">
                            ...
                            <ul class="article-authors">
                                @foreach ($article_array["authors_detail"] as $author_detail)
                                       <li class="article-corres-author">
                                          <a href="@if($author_detail['email'] != '' ) mailto: {{ $author_detail['email'] }} @else javascript:; @endif " class="author_name">
                                           {{ $author_detail['name'] }} <sup>  {{ $loop->iteration }}  @if( $author_detail['corresponding'] )*@endif</sup>
                                          </a>
                                          @if(array_key_exists('orcid_id', $author_detail) && $author_detail['orcid_id'] !='')
                                          <span class="orcid-link">
                                          <a href="https://orcid.org/{{ $author_detail['orcid_id'] }}" style="-webkit-user-select: none;
                                             -webkit-touch-callout: none;
                                             -moz-user-select: none;
                                             -ms-user-select: none;
                                             user-select: none;" oncontextmenu="return false;" target="_blank">
                                            </a>
                                        </span>
                                            @endif
                             ...
                             <p class="author_bio">
                              @foreach ($article_array["authors_detail"] as $author_detail)
                                      @if( $author_detail['bio'] != "") <sup>{{ $loop -> iteration }}</sup> {{ $author_detail['bio'] }} {!! $loop -> remaining ? '&nbsp;' . ' | '. '&nbsp;' : '' !!} @endif
                              @endforeach
                             </p>
                            ...
                            <ul class="article-informations">
                               <li class="article-citation">
                                  ...
                                  <!--Download Citation</a>-->
                                  DOI: &nbsp;
                                  <a class="doi-link" href="https://doi.org/10.59762/{{ $article_array["journal_abbr"] }}{{ $article_array["issn"] }}{{ $article_vol_value }}{{ $article_array["issue_no"] }}{{ $article_array["timestamp"] }}" style="-webkit-user-select: none;
                                     -webkit-touch-callout: none;
                                     -moz-user-select: none;
                                     -ms-user-select: none;
                                     user-select: none;" oncontextmenu="return false;" id="copyDoiToClipboard">
                                  ...
                                  <button class="copy-btn" id="copyButton" onclick="copydoi()"><i class="far fa-copy"></i></button>
                               </li>
                            </ul>
                      ...
                      <div class="col-md-4 col-xl-4 col-sm-12">
                          <div class="article_filesbtn">
                                       ...
                                       <a href="{{URL::asset('assets/articles/pdf/')}}/{{$article_array["article_pdf"]}}" target="_blank">Download Full Article</a>
                                       @if($article_array["article_code"] == '5246025')
                                       <a href="{{URL::asset('assets/articles/pdf/')}}/5-52471-Gleemoore-C-Makie-Supporting-Material.pdf" target="_blank">Supporting Material</a>
                                       @endif
                             </div>
                           ...
                           <div class="accessLogo">
                            ...
                            <div class="creative_lisence">
                                ...
                                <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank">
                                    <img src="https://mirrors.creativecommons.org/presskit/buttons/88x31/png/by.png" alt="Creative Commons" width="100"/>
                                </a>
                   ...
                   <div class="row">
                      ...
                      <div class="col-md-8 col-xl-8 col-sm-12 col_article_bordered">
                         <ul class="nav nav-pills search-journal-nav-pills article-nav-pills">
                            <li class="nav-item"> <a class="nav-link active" data-bs-toggle="pill" href="#full-article" role="tab" aria-controls="pills-full-article" aria-selected="true">Abstract</a> </li>
                            ...
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="pill" href="#references" role="tab" aria-controls="pills-references" aria-selected="true"> References</a> </li>
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="pill" href="#citations" role="tab" aria-controls="pills-citations" aria-selected="false">Citations </a> </li>
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="pill" href="#metrics" role="tab" aria-controls="pills-metrics" aria-selected="false">Metrics </a> </li>
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="pill" href="#copyrights_permissions" role="tab" aria-controls="pills-permissions" aria-selected="false">Copyright &amp; Permissions </a> </li>
                         </ul>
                         <div class="tab-content mt-3 aos-init aos-animate" data-aos="zoom-in">
                            <div class="tab-pane fade show active" id="full-article" role="tabpanel" aria-labelledby="metrics-tab">
                                  ...
                                  <li>
                                    ...
                                    @if( ! (($article_array["journal_abbr"]  == 'cli' && $article_array["article_code"] == '5242906') ||  ($article_array["journal_abbr"]  == 'seer' && $article_array["article_code"] == '5243101')) )
                                        ...
                                        <div class="keywords_article">
                                            <p><b>Keywords:</b> {{$article_array["article_keywords"]}} </p>
                                        </div>
                                     @endif
                                     </div>
                            ...
                            <div class="tab-pane fade" id="figures" role="tabpanel" aria-labelledby="aims-tab">
                               <ul class="search-results">
                                  <li>
                                     <div class="article-titles">
                                        <h2>Figures</h2>
                            ...
                            <div class="tab-pane fade" id="references" role="tabpanel" aria-labelledby="editorial-tab">
                               <ul class="search-results">
                                  <li>
                                     <div class="article-titles">
                                        @if( ! (($article_array["journal_abbr"]  == 'cli' && $article_array["article_code"] == '5242906') ||  ($article_array["journal_abbr"]  == 'seer' && $article_array["article_code"] == '5243101')) )
                            ...
                            <div class="tab-pane fade" id="citations" role="tabpanel" aria-labelledby="instructions-tab">
                               <ul class="search-results">
                                  <li>
                                     <div class="article-titles">
                                     @if( ! (($article_array["journal_abbr"]  == 'cli' && $article_array["article_code"] == '5242906') ||  ($article_array["journal_abbr"]  == 'seer' && $article_array["article_code"] == '5243101')) )
                                        ...
                                        <p>
                                           ...
                                           @endforeach
                                              ...
                                              (2023). <span class="a_title">{!! $article_array["article_title"] !!}</span>. <i class="jtitle">{{ $article_array["journal_title"] }}</i>, <i>{{ $article_vol_value }}</i>({{ $article_array["issue_no"] }}), {{ $article_array["pages"] }}.  doi.org/10.59762/{{ $article_array["journal_abbr"] }}{{ $article_array["issn"] }}{{ $article_array["vol_no"] }}{{ $article_array["issue_no"] }}{{ $article_array["timestamp"] }}
                                        </p>
                                    @endif
                                     </div>
                                  </li>
                            ...
                            <div class="tab-pane fade" id="metrics" role="tabpanel" aria-labelledby="instructions-tab">
                               <ul class="search-results">
                                  <li>
                                     <div class="article-titles">
                            ...
                            <div class="tab-pane fade" id="copyrights_permissions" role="tabpanel" aria-labelledby="instructions-tab">
                               <ul class="search-results">
                                  <li>
                                     <div class="article-titles">
                                        <h2>Copyright and Permissions</h2>
                                      <p>At Guinness Press, authors retain the copyright for all articles published in our journals. These articles are licensed under the open-access Creative Commons CC BY 4.0 license, granting free access for reading and download. Additionally, the original published version must be appropriately cited when reusing or quoting the article. These terms ensure widespread accessibility while ensuring proper attribution to the authors.</p>
                                         <p>All content published by Guinness Press is safeguarded by international copyright and intellectual property regulations. We kindly request that you honor these protections when utilizing our materials. </p>
                                         <p>For further information, please contact us at info@guinnesspress.org.</p>
                                     </div>
                                  </li>
                               </ul>
                            </div>
                         ...
                         <div class="col-md-4 col-xl-4 col-sm-12">
                            <div class="socialshare_links">
                               <ul>
                                  <li>
                                     <a class="share_facebook" rel="nofollow noopener" target="_blank" href="http://www.facebook.com/sharer.php?u={{url()->current()}}">
                                     <i class="fa-brands fa-facebook" aria-hidden="true"></i>
                                     </a>
                                  </li>
                                  <li>
                                     <a class="share_twitter" rel="nofollow noopener" target="_blank" href="http://twitter.com/share?text={!!$article_array["article_title"]!!}&amp;url={{url()->current()}}">
                                     <i class="fa-brands fa-twitter" aria-hidden="true"></i>
                                     </a>
                                  </li>
                                  <li>
                                     <a class="share_linkedin" rel="nofollow noopener" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{url()->current()}}">
                            ...
                            <!--<div class="related_research_article article_right_sidebar">-->
                               <ul class="nav nav-pills search-journal-nav-pills explore-pills">
                                  ...
                                  <li class="nav-item"> <a class="nav-link active" data-bs-toggle="pill" href="#trending" role="tab" aria-controls="pills-trending" aria-selected="false">Recommended Articles</a> </li>
                               ...
                               <div class="tab-content mt-3">
                                  <div class="tab-pane fade show active" id="trending" role="tabpanel" aria-labelledby="most-trending">
                                     <ul class="search-results explore-list">
                                        <li>
                                <div class="article-titles">
                               <h2><a href="{{url('')}}/publication/journal/ijerm/1024923">A THEORETICAL PERSPECTIVE ON HOW DIGITALIZATION HAS EVOLVED ORGANIZATIONAL CULTURE</a></h2>
                               <p>Author(s): Munzallin Munaf</p>
                               <div class="article-btn">
                                   <p>Article | Published Online: 05 Oct 2023 | Pages [1 - 8]</p>
                                   <a href="{{url('')}}/publication/journal/ijerm/1024923" class="btn1">Read More</a>
                               </div>
                            </div>

                             <div class="article-titles">
                               <h2><a href="{{url('')}}/publication/journal/ijerm/1024925">ADAPTATION OF SOCRATIVE APPLICATION AS ONLINE TEACHING PLATFORM DURING THE COVID-19 PANDEMIC</a></h2>
                              <p>Author(s): Mark Treve</p>
                               <div class="article-btn">
                                   <p>Article | Published Online: 05 Oct 2023 | Pages [17 - 26]</p>
                                   <a href="{{url('')}}/publication/journal/ijerm/1024925" class="btn1">Read More</a>
                               </div>
                            </div>
                             <div class="article-titles">
                               <h2><a href="{{url('')}}/publication/journal/jblm/5243017">UTILIZING NET PROMOTER SCORE TO ASSESS CUSTOMER SATISFACTION AND BRAND LOYALTY IN THE REAL ESTATE INDUSTRY OF THAILAND</a></h2>
                               <p>Author(s): Nilubon Sivabrovornvatana</p>
                               <div class="article-btn">
                                   <p>Article | Published Online: 09 Oct 2023 | Pages [56 - 66]</p>
                                   <a href="{{url('')}}/publication/journal/jblm/5243017" class="btn1">Read More</a>
                               </div>
                            </div>
                                        </li>
                                     </ul>
