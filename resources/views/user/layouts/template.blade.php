...
src="https://www.facebook.com/tr?id=362843969490645&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
   ...
   <body>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="https://www.guinnesspress.org/about-us">About</a>
                                                <div class="dropdown-menu dropdown-menu-single" aria-labelledby="navbarDropdown">
                                                    ...
                                                    <a class="dropdown-item" href="{{url('/peer-review-process')}}">Peer Review Process</a>
                                                    <a class="dropdown-item" href="{{url('/archival-practices')}}">Archival Practices</a>
                                                    ...
                                                    <a class="dropdown-item" href="{{url('/mission-vision')}}">Mission Vission and Values</a>
                                                    <a class="dropdown-item" href="{{url('/publication-ethics-statement')}}">Publication Ethics Statement</a>
                                                </div>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-single" aria-labelledby="navbarDropdown">
                                                   <a class="dropdown-item" href="{{url('/benefits-of-being-a-reviewer')}}">Benefits of Being A Reviewer</a>
                                                   <a class="dropdown-item" href="{{url('/reviewer-guidelines')}}">Reviewer Guidelines</a>
                                                   <a class="dropdown-item" href="{{url('/authors-guidelines')}}">Authors Guidelines</a>
                                                   <a class="dropdown-item" href="{{url('/librarian-resource-center')}}">Librarian Resource Center</a>
                                                </div>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" aria-current="page" href="{{url('/journals')}}">Journals</a>
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-single" aria-labelledby="navbarDropdown">
                                                   ...
                                                   <a class="dropdown-item" href="{{url('/librarian-resource-center')}}">Librarian Resource Center</a>
                                                   <a class="dropdown-item" href="{{url('/crossmark-policy')}}">Crossmark Policy</a>
                                                   <a class="dropdown-item" href="{{url('/articles-correction')}}">Articles Correction</a>
                                                   <a class="dropdown-item" href="{{url('/articles-retraction')}}">Articles Retraction</a>
                                                   <a class="dropdown-item" href="{{url('/publication-procedure')}}">Publication Procedure</a>
                                                   <a class="dropdown-item" href="{{url('/policies-and-statements')}}">Policies and Statements</a>
                                                   <a class="dropdown-item" href="{{url('/copyright-agreement')}}">Copyright Agreement</a>
                                                   <!--<a class="dropdown-item" href="{{url('/publication-fees')}}">Publication Fees</a>-->
                ...
                <div class="container">
                    <div class="row main-footer-row-one">
                     <div class="col col-lg-3 col-md-3 fcol2">
                         <a href="https://www.guinnesspress.org">
                           <img src="{{asset('assets/images/logo-dark.png')}}" title="Guinness Press" alt="Guinness Press" loading="lazy">
                        </a>
                         ...
                         <ul class="social_icons">
                             <li><a href="https://www.facebook.com/guinnesspressofficial" aria-label="Facebook" target="_blank">
                             <i class="fab fa-facebook"></i></a>
                             </li>
                             <li><a href="https://www.pinterest.co.uk/guinness_press/" aria-label="Pinterest" target="_blank">
                                 <i class="fab fa-pinterest"></i>
                             </a></li>
                             <!--<li><a href="https://www.instagram.com/" aria-label="Instagram" target="_blank" >-->
                             <!--    <i class="fab fa-instagram"></i>-->
                             <!--</a></li>-->
                             <li><a href="https://www.linkedin.com/company/guinnesspress/" target="_blank" aria-label="Linkedin">
                             ...
                             <ul class="contactinfo">
                                ...
                                <li>
                                    <a href="https://maps.app.goo.gl/Fm3HJTDZVVXiwCLE9">
                                        <i class="fa fa-location"></i><span>16192 Coastal Highway Lewes, DE 19958, USA</span>
                                    </a>
                                </li>
                            </ul>
                     </div>
                    ...
                    <div class="col col-12 col-xl-3 fcol2">
                           ...
                           <ul>
                             ...
                             <!--</li>-->
                             <li>
                                 <a href="{{url('/librarian-resource-center')}}"><i class="fa fa-check"></i><span>Librarians</span></a>
                             </li>
                             <!--<li>-->
                             ...
                             <!--</li>-->
                              <li>
                                 <a href="{{url('/reviewer-guidelines')}}"><i class="fa fa-check"></i><span>Reviewers</span></a>
                             </li>
                             <li>
                                 <a href="{{url('/authors-guidelines')}}"><i class="fa fa-check"></i><span>Author's Guidelines</span></a>
                             </li>
                              <li>
                                 <a href="{{url('/crossmark-policy')}}"><i class="fa fa-check"></i><span>Crossmark Policy</span></a>
                             </li>
                            <li>
                                 <a href="{{url('/article-correction')}}"><i class="fa fa-check"></i><span>Article Correction</span></a>
                             </li>
                              <li>
                                 <a href="{{url('/article-retraction')}}"><i class="fa fa-check"></i><span>Article Retraction</span></a>
                             </li>
                            <li>
                                 <a href="{{url('/publication-procedure')}}"><i class="fa fa-check"></i><span>Publication Procedure</span></a>
                             </li>
                           </ul>
                     </div>
                     <div class="col col-12 col-xl-3 fcol2">
                           ...
                           <ul>
                             ...
                             <li>
                                 <a href="{{url('/contact-us')}}"><i class="fa fa-check"></i><span>Contact Us</span></a>
                             </li>
                             <!--<li>-->
                             ...
                             <!--</li>-->
                             <li>
                                 <a href="{{url('/policies-and-statements')}}"><i class="fa fa-check"></i><span>Policies and Statements</span></a>
                             </li>
                             <li>
                                 <a href="{{url('/peer-review-process')}}"><i class="fa fa-check"></i><span>Peer Review Process</span></a>
                             </li>
                             <li>
                                 <a href="{{url('/copyright-agreement')}}"><i class="fa fa-check"></i><span>Copyright Agreement</span></a>
                             </li>
                            <li>
                                 <a href="{{url('/archival-practices')}}"><i class="fa fa-check"></i><span>Archival Practices</span></a>
                             </li>
                             <li>
                                 <a href="{{url('/publication-fees')}}"><i class="fa fa-check"></i><span>Publication Fees</span></a>
                             </li>
                               <li>
                                 <a href="{{url('/repository-policy')}}"><i class="fa fa-check"></i><span>Repository Policy</span></a>
                             </li>
                           </ul>
                     </div>
                  </div>
                 ...
                 $.ajax({
                     ...
                     success:function (data) {
                         if(data==''){
                             ...
                             $('#search_result_list').append('<li><a href="">No Data Found</a></li>');
      ...
      <div style="display: none;" class="popupform submitArticlePopup" id="submitArticlePopup">
         ...
         <form action="{{route('send.articlemail')}}" method="POST" class="cmxform web-package-form" id="articleSub_form" enctype="multipart/form-data">
            @csrf
            <div class="row">
               <div class="col">
                        ...
                        <ul>
                           <li>
                              ...
                              <select name="journal" required placeholder="Journal *" id="sa_journal">
                                 ...
                                 <option value="International Journal Of Empirical Research Methods">International Journal Of Empirical Research Methods</option>
                                 <option value="Journal Of Business Leadership And Management">Journal Of Business Leadership And Management</option>
                                 <option value="Cultural Landscape Insights">Cultural Landscape Insights</option>
                                 <option value="Current Integrative Engineering">Current Integrative Engineering</option>
                                 <option value="Sustainable Energy And Environment Review">Sustainable Energy And Environment Review</option>
                                 <option value="Recent Educational Research">Recent Educational Research</option>
                                 <option value="Pharmaceutical Breakthroughs">Pharmaceutical Breakthroughs</option>
                                 ...
                                 <option value="Advanced Chemistry Insights">Advanced Chemistry Insights</option>
                              </select>
                           </li>
                        </ul>
                     </div>
                     ...
                     <div class="col">
                        <ul>
                           <li>
                              ...
                              <a class="btn btn-primary text-light articlesub-button" role="button" id="articlesub-button" aria-disabled="false">Upload Your Manuscript</a>
                              </label>
                              <input type="file" required name="article_fileattachment[]" accept=".png,.docx,jpeg,.pdf,.xlsx" id="article_fileattachment" style="opacity: 0;" multiple max-size="2048"/>
                              <div id="files-area">
                                 <span id="filesList">
                  ...
                  <div class="row">
                     <div class="col">
                        <ul>
                           <li>
                              <i class="fa fa-user" aria-hidden="true"></i>
                              <input type="text" required placeholder="Full Name *" id ="wnm" name="author_name">
                           </li>
                        </ul>
                     </div>
                     <div class="col">
                        <ul>
                           <li>
                              <i class="fa fa-phone" aria-hidden="true"></i>
                              <input type="number" required minlength="10" required placeholder="Phone No. *" id="wpn" name="author_number">
                           </li>
                        </ul>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <ul>
                           <li>
                              <i class="fa fa-envelope" aria-hidden="true"></i>
                              <input type="email" required placeholder="Email Address *" id="wem" name="author_email">
                           </li>
                        </ul>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <ul>
                           <li>
                              <i class="fa fa-user" aria-hidden="true"></i>
                              <input type="text" required placeholder="Country *" id ="wnm" name="author_country">
                           </li>
                        </ul>
                     </div>
                     <!--<div class="col">-->
            ...
            <div class="submit_button">
               <ul>
                  <li>
                     <input type="submit"  value="Submit" id="your-article-submit" name="your-article-submit" placeholder="Submit Your Article" required>
                  </li>
               </ul>
            </div>
         </form>
