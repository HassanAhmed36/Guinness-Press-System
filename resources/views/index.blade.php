                ...
                <div class="sec_4_boxes">
                    <div class="row">
                        ...
                        {{-- @foreach ($data as $datas)
                            <?php
                            $jsonArray = json_decode($datas->image, true);
                            ?>
                            <?php
                            $description = '';
                            foreach ($descr as $descrs) {
                                if ($descrs->category_id == $datas->category_id) {
                                    $description = $descrs->setting_value;
                                    //echo $description;
                                }
                            }
                            ?>
                                ...
                                <div class="box_item box_item_2">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-3 box_img">
                                            <img src="https://guinnesspress.org/journals/journals/1/categories/{{ $jsonArray['name'] }}"
                                                class="img-fluid">
                                        </div>
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-9">
                                            <h3 class="cocogoose_light text-capitalize">
                                                <?php echo $datas->setting_value; ?>
                                            </h3>
                                            <p class="poppins_fonts">
                                                <?= $description ?>
                                            </p>
            ...
            <div class="owl-carousel" id="slider_2">
                ...
                {{-- @foreach ($journals as $journal)
                    ...
                    if($detail->setting_name=='acronym' && $detail->locale=='en'){
                        $journalname=$detail->setting_value.' 1';
                    }
                    ...
                    ?>
                        <div class="item">
                            <a href="{{ url('/publication/journal', ['journal_name' => $journal->path]) }}">
                                <img src="https://newversion.guinnesspress.org/ojs/public/journals/{{ $journal->journal_id }}/{{ $jsonArray['uploadName'] }}"
                                    class="img-fluid">
                            </a>
                        </div>
                        <?php
